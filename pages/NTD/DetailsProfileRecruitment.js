...
const DetailsProfileRecruitment = ({ navigation }) => {
...
const [dataContact,setDataContact]=useState({
  ...
  const renderRecruitsments=({item})=>{
    if(item.statusRe==='đã hủy'||item.statusRe==='đang chờ'){
      return null
    }
    return (
      ...
      <ScrollView>
        ...
        <View style={{
          ...
          <Text style={{
                ...
                textAlign: 'left',
                color:'#4a80f5',
                marginRight: -5,}} >{dataBrand.address}</Text>    
                </View>  
        </View>
        </View>
...
export default DetailsProfileRecruitment;
